"""API Routes for Email Processing - Simplified with Keyword-Based Classification"""
...
async def process_email(email: EmailRequest) -> ProcessingResult:
    """Process incoming customer support email using keyword-based classification.
